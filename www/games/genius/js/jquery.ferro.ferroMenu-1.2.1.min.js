...
(function(e) {
    var t = {ferroMenuCreate: function(t) {
            function C(e, t, n) {
            ...
            function _() {
                e(r + " > li").each(function(t) {
                    e(this).css({display: "inline-block", position: "absolute", zIndex: 999});
                    s[t] = false;
                    ...
                    switch (o) {
                        case"left-bottom":
                            e("#" + E).css({bottom: 0, left: 0, marginLeft: i.margin, marginBottom: i.margin, zIndex: 1e3});
                            var n = -Math.PI / 2 + t * (Math.PI / 2 / b);
                            var u = i.radius * Math.sin(n);
                            var a = i.radius * Math.cos(n);
                            break;
                        case"center-bottom":
                            e("#" + E).css({bottom: 0, left: "50%", marginLeft: -(e("#" + E).width() / 2), marginBottom: i.margin, zIndex: 1e3});
                            var n = Math.PI + t * (Math.PI / b);
                            var u = i.radius * Math.sin(n);
                            var a = i.radius * Math.cos(n);
                            break;
                        case"right-bottom":
                            e("#" + E).css({bottom: 0, right: 0, marginRight: i.margin, marginBottom: i.margin, zIndex: 1e3});
                            var n = Math.PI + t * (Math.PI / 2 / b);
                            var u = i.radius * Math.sin(n);
                            var a = i.radius * Math.cos(n);
                            break;
                        case"left-top":
                            e("#" + E).css({top: 0, left: 0, marginLeft: i.margin, marginTop: i.margin, zIndex: 1e3});
                            var n = -Math.PI / 2 + t * (Math.PI / 2 / b);
                            var u = -i.radius * Math.sin(n);
                            var a = i.radius * Math.cos(n);
                            break;
                        case"center-top":
                            e("#" + E).css({top: 0, left: "50%", marginLeft: -(e("#" + E).width() / 2), marginTop: i.margin, zIndex: 1e3});
                            var n = Math.PI + t * (Math.PI / b);
                            var u = -i.radius * Math.sin(n);
                            var a = i.radius * Math.cos(n);
                            break;
                        case"right-top":
                            e("#" + E).css({top: 0, right: 0, marginRight: i.margin, marginTop: i.margin, zIndex: 1e3});
                            var n = Math.PI + t * (Math.PI / 2 / b);
                            var u = -i.radius * Math.sin(n);
                            var a = i.radius * Math.cos(n);
                            break;
                        case"left-center":
                            e("#" + E).css({top: "50%", left: 0, marginTop: -(e("#" + E).height() / 2), marginLeft: i.margin, zIndex: 1e3});
                            var n = -Math.PI / 2 + t * (Math.PI / b);
                            var u = i.radius * Math.sin(n);
                            var a = i.radius * Math.cos(n);
                            break;
                        case"right-center":
                            e("#" + E).css({top: "50%", right: 0, marginTop: -(e("#" + E).height() / 2), marginRight: i.margin, zIndex: 1e3});
                            var n = -Math.PI / 2 + t * (Math.PI / b);
                            var u = i.radius * Math.sin(n);
                            var a = -i.radius * Math.cos(n);
                            break;
                        case"center-center":
                            e("#" + E).css({top: "50%", left: "50%", marginTop: -(e("#" + E).height() / 2), marginLeft: -(e("#" + E).width() / 2), zIndex: 1e3});
                            var n = -Math.PI / 2 + t * (Math.PI * 2 / e(r).find("li").length);
                            var u = i.radius * Math.sin(n);
                            var a = i.radius * Math.cos(n);
                            break
                    }
                    e("#" + E).data("startingPosition", {x: e("#" + E).offset().left, y: e("#" + E).offset().top});
                    e(this).css({top: e("#" + E).offset().top + e("#" + E).outerHeight() / 2 - e(this).height() / 2, left: e("#" + E).offset().left + e("#" + E).outerWidth() / 2 - e(this).width() / 2});
                    if (u <= .1 && u >= -.1) {
                        u = 0
                    }
                    if (a <= .1 && a >= -.1) {
                    ...
                    e(this).data({end: {top: u, left: a}})
                })
            }
            function D(t) {
                var n = {menuElement: r, position: o, opened: u};
                e.event.trigger({type: t, menustatus: n})
            }
            function p() {
            ...
            var n = {closeTime: 500, delay: 0, drag: true, easing: "cubic-bezier(0.680, -0.550, 0.265, 1.550)", margin: 10, position: "left-bottom", radius: 150, rotation: 0, opened: false, openTime: 500};
            var r = this.selector;
            var i = e.extend({}, n, t);
            var s = new Array;
            var o = i.position;
